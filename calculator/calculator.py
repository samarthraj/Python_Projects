...
class Calculator: 
    ...
    def solve(self):
        ...
        #safer option rather than using eval
        #result = ast.literal_eval(self.entry_value)
        self.equation.set(result)

# Creating the main window (Tk instance)
root = Tk()  # This is an instance of the Tk class (master)

# Creating the MyWindow class instance and passing 'root' as the master
